...
public class BusinessMan extends TabActivity {
...
TabHost tbhost= getTabHost();
		...
		Intent yogaIntent=new Intent(this,YogaBusinessman.class);
		...
		Intent healthIntent=new Intent(this,HealthBusinessman.class);
		...
		//tab for Meditation
				...
				Intent meditationIntent=new Intent(this,MeditationBusinessman.class);
				...
				Intent relaxationIntent=new Intent(this,RelaxationBusinessman.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.business_man, menu);
		return true;
	}
